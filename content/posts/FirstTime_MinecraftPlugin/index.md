...
{{< gallery caption-effect="fade" >}}
  ...
  {{< figure src="/img/ErrorLog.jpg" link="ErrorLog.jpg" caption="ErrorLog" alt="A screenshot of the error log." >}}
...
{{< gallery caption-effect="fade" >}}
  {{< figure src="/img/SuccessOutput.jpg" link="/img/SuccessOutput.jpg" caption="ErrorLog" alt="A screenshot of the error log." >}}
{{< /gallery >}}